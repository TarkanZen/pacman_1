...
def depthFirstSearch(problem: SearchProblem):
    ...
    fringe = util.Stack()
    fringe.push((problem.getStartState(), [], set()))

    while not fringe.isEmpty():
        node, actions, visited_states = fringe.pop()
        ...
        if node not in visited_states:
            ...
            for successor, action, stepCost in problem.getSuccessors(node):
                ...
                fringe.push((successor, new_actions, visited_states))
...
def aStarSearch(problem: SearchProblem, heuristic=nullHeuristic):
    ...
    fringe = util.PriorityQueue()
    fringe.push((problem.getStartState(), [], 0), 0)  # (state, actions, g(n)), priority = g(n) + h(n)
    explored = set()
    ...
    while not fringe.isEmpty():
        ...
        if node not in explored:
            ...
            for successor, action, stepCost in problem.getSuccessors(node):
                ...
                fringe.push((successor, new_actions, new_cost), heuristic_cost)
